...
const MEMBER_WEIGHT = 80;
const BALLOON_PAYLOAD = 0.0048;

export function Journey(object, crew, balloons) {
  this.isPossible = function () {
    const totalWeight = object.weight + crew * MEMBER_WEIGHT;
    const maxPayload = balloons * BALLOON_PAYLOAD;

    return maxPayload >= totalWeight;
  };
}